...
export const DEFAULT_OPENROUTER_FOOD_VISION_FALLBACK_MODEL = 'google/gemini-2.5-flash';
...
export function getOpenRouterFoodVisionModels(env: OpenRouterModelEnv = process.env): string[] {
  ...
  const fallbackModel =
    cleanModelId(env.OPENROUTER_FOOD_VISION_FALLBACK_MODEL) ??
    DEFAULT_OPENROUTER_FOOD_VISION_FALLBACK_MODEL;

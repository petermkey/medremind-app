...
test('supportedOuraScopes keeps heart_health/stress/ring_configuration but drops unsupported scopes', () => {
  assert.deepEqual(
    supportedOuraScopes('email personal daily heartrate tag workout session spo2 ring_configuration stress heart_health bogus_scope'),

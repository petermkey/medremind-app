                ...
                <>
                  ...
                  <Select label="Form" value={draft.doseForm ?? 'tablet'} onChange={e => setDraft(d => ({ ...d, doseForm: e.target.value as DoseForm }))}
                    options={[
                      ...
                      {value:'injection',label:'Injection'},{value:'drops',label:'Drops/Liquid'},
                      {value:'cream',label:'Cream/Gel'},{value:'powder',label:'Powder'},
                      {value:'patch',label:'Patch'},{value:'inhaler',label:'Inhaler'},{value:'other',label:'Other'},
                    ]}
                  />
                  <Select label="Route" value={draft.route ?? 'oral'} onChange={e => setDraft(d => ({ ...d, route: e.target.value as RouteOfAdmin }))}
                    options={[
                      {value:'oral',label:'Oral'},{value:'subcutaneous',label:'Subcutaneous'},
                      {value:'intramuscular',label:'Intramuscular'},{value:'topical',label:'Topical'},
                      {value:'sublingual',label:'Sublingual'},{value:'inhalation',label:'Inhalation'},
                      {value:'nasal',label:'Nasal'},{value:'iv',label:'IV'},{value:'other',label:'Other'},
                    ]}
                  />

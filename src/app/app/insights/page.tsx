    ...
    return (
      <div className="flex flex-col h-full">
        <div className="px-5 pt-4 pb-2 flex-shrink-0">
          <h1 className="text-xl font-semibold tracking-[-0.02em] text-[var(--text)]">Insights</h1>
        </div>
        <div className="flex-1 overflow-y-auto px-5 pb-6 flex items-center justify-center">
          <div className="text-center">
            <div className="text-sm font-bold text-[var(--text)] mb-1">No nutrition data yet</div>
            <div className="text-xs text-[var(--muted)]">Log a meal to see your 7-day summary.</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6">
        ...
        <div className="bg-[var(--surface)] border border-[rgba(var(--overlay-rgb),0.08)] rounded-2xl p-4 mb-4 mt-3">
          <div className="text-xs font-bold text-[var(--muted)] uppercase tracking-widest mb-4">7-Day Average</div>

          <div className="space-y-4">
            {/* Calories */}
            <div>
              <div className="flex justify-between mb-1.5">
                <span className="text-sm font-semibold text-[var(--text)]">Calories</span>
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                <span className="text-sm font-semibold text-[var(--text)]">Protein</span>
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                <span className="text-sm font-semibold text-[var(--text)]">Fiber</span>

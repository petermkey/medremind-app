        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer mt-1">
            ...
            <span className="text-xs text-[#8B949E] leading-relaxed">
              I agree to the{' '}
              <a href="#" className="text-[#3B82F6]">Terms of Service</a>{' '}
              and{' '}
              <a href="#" className="text-[#3B82F6]">Privacy Policy</a>.
              This app does not provide medical advice.
            </span>
          </label>

          {error && (
            <p className="text-sm text-[#EF4444] bg-[rgba(239,68,68,0.1)] px-4 py-3 rounded-xl">{error}</p>
          )}
